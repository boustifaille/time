...
def recolteH():
    ...
    heureDebutMT = str(datetime.time(9,45,00))
    heureDebutAT = str(datetime.time(15,5,00))
    ...
    recolteH.d5 = datetime.datetime.strptime(heureDebutMT, '%H:%M:%S')    # Matin
    recolteH.d7 = datetime.datetime.strptime(heureDebutAT, '%H:%M:%S')    # Après-midi
